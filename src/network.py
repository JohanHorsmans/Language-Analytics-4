...
ap.add_argument("-i", "--input", default = os.path.join("..", "data", "weighted_edges_df.csv"), type = str, help = "string, path to input file. [DEFAULT]: \"..\", \"data\", \"weighted_edges_df.csv\"")
...
ap.add_argument("-pf", "--plot_file", default = os.path.join("..", "data", "viz","network_visualization.png"), type = str, help = "str, where to save the plot output [DEFAULT]:  \"..\", \"data\", \"viz\" \"network_visualization.png\" ")
ap.add_argument("-o", "--output",default = os.path.join("..", "data", "output", "metrics.csv"), type = str, help = "str, path to output file. [DEFAULT]: \"..\", \"data\", \"metrics.csv\" ")
